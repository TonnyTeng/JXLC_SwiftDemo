...
protocol LCPassWordViewDelegate : NSObjectProtocol{
    
    func entryComplete(password:String)
}

@IBDesignable  class LCPassWordView: UIView {
    ...
    weak var delegate: LCPassWordViewDelegate?
...
extension LCPassWordView:UITextFieldDelegate{
